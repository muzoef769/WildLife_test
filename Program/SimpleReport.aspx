                ...
                <div class="tab-content ">
                    <div id="ProgramTotal" class="tab-pane fade show active ">
                        ...
                        <div id="simpleTab" class="row table-responsive" style="width: 85%;">
                            <div class='tableauPlaceholder' id='viz1543367766939' style='position: relative'>
                                <noscript><a href='#'>
                                    <img alt=' ' src='https:&#47;&#47;public.tableau.com&#47;static&#47;images&#47;JW&#47;JW83YTYM2&#47;1_rss.png' style='border: none' /></a></noscript>
                                <object class='tableauViz' style='display: none;'>
                                    <param name='host_url' value='https%3A%2F%2Fpublic.tableau.com%2F' />
                                    <param name='embed_code_version' value='3' />
                                    <param name='path' value='shared&#47;JW83YTYM2' />
                                    <param name='toolbar' value='yes' />
                                    <param name='static_image' value='https:&#47;&#47;public.tableau.com&#47;static&#47;images&#47;JW&#47;JW83YTYM2&#47;1.png' />
                ...
                <div id="Annual" class="tab-pane fade">
                    ...
                    <div class="row mx-auto d-flex justify-content-center table-responsive">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-s-12">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource48" runat="server" ConnectionString="<%$ ConnectionStrings:connString %>" SelectCommand="Select distinct AnimalName, count(aa.NewProgramID) as 'Programs', sum(TotalPeople) as 'TotalPeople' from dbo.AssignAnimal aa left outer join dbo.Animal a on a.AnimalID=aa.AnimalID inner join dbo.NewProgram np on np.NewProgramID = aa.NewProgramID group by AnimalName"></asp:SqlDataSource>
                            <div class="row">
                                <div class="col-md-12">
