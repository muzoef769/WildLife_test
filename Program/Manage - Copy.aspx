  ...
  if(activeTab){
    $('#myTab a[href="' + activeTab + '"]').tab('show');
            ...
            <ul class="nav nav-tabs  col-xl-12 col-lg-12 col-md-12 col-s-12 " id="myTab" style=" padding-left:15px; border-bottom:none;" role="tablist">
                <li class="nav-item ">
                    <a style=" margin-right:5px; color:black;" class="nav-link active" id="profile-tab" data-toggle="tab" href="#All" role="tab" aria-controls="profile" aria-selected="true">User Permissions</a>
                </li>
                <li class="nav-item ">
                    <a style=" margin-right:5px; color:black;"class="nav-link  " id="homee-tab" data-toggle="tab" href="#Staff" role="tab" aria-controls="homee" aria-selected="false">Approve Staff</a>
                </li>
                <li class="nav-item ">
                    <a style=" margin-right:5px; color:black;"class="nav-link" id="home-tab" data-toggle="tab" href="#Volunteer" role="tab" aria-controls="home" aria-selected="false">Approve Volunteers</a>
                </li>
